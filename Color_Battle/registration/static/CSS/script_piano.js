...
const C4 = new Audio("http://127.0.0.1:8000/static/Sounds/C4.mp3");
const Db4 = new Audio("http://127.0.0.1:8000/static/Sounds/Db4.mp3");
const D4 = new Audio("http://127.0.0.1:8000/static/Sounds/D4.mp3");
const Eb4 = new Audio("http://127.0.0.1:8000/static/Sounds/Eb4.mp3");
const E4 = new Audio("http://127.0.0.1:8000/static/Sounds/E4.mp3");
const F4 = new Audio("http://127.0.0.1:8000/static/Sounds/F4.mp3");
const Gb4 = new Audio("http://127.0.0.1:8000/static/Sounds/Gb4.mp3");
const G4 = new Audio("http://127.0.0.1:8000/static/Sounds/G4.mp3");
const Ab4 = new Audio("http://127.0.0.1:8000/static/Sounds/Ab4.mp3");
const A4 = new Audio("http://127.0.0.1:8000/static/Sounds/A4.mp3");
const Bb4 = new Audio("http://127.0.0.1:8000/static/Sounds/Bb4.mp3");
const B4 = new Audio("http://127.0.0.1:8000/static/Sounds/B4.mp3");
const C5 = new Audio("http://127.0.0.1:8000/static/Sounds/C5.mp3");
const Db5 = new Audio("http://127.0.0.1:8000/static/Sounds/Db5.mp3");
const D5 = new Audio("http://127.0.0.1:8000/static/Sounds/D5.mp3");
const Eb5 = new Audio("http://127.0.0.1:8000/static/Sounds/Eb5.mp3");
const E5 = new Audio("http://127.0.0.1:8000/static/Sounds/E5.mp3");
